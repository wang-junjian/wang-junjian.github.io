...
**GitHub Code**: https://github.com/wang-junjian/claude-code-security-review

**新增功能**：
- 代码仓库安全评估工具，支持对整个代码仓库进行安全审查，并生成详细的评估结果日志。
- 增加 Web 展示评估结果的功能，提供更直观的安全审查报告。
- 对 `/security-review`, `custom-filtering-instructions`, `custom-security-scan-instructions` 进行展示和编辑的功能。

![](/images/2026/Claude/claude-code-security-review/security-review.png)

![](/images/2026/Claude/claude-code-security-review/security-review-repository.png)
