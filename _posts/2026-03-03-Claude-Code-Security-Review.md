...
随着开发者越来越多地依赖 AI 来加快交付速度和构建更复杂的系统，确保代码安全变得愈发关键。这些新功能允许你将安全审查集成到现有工作流中，帮助你在漏洞进入生产环境之前将其截获。
...
这是一个基于 AI 驱动的 GitHub Action 安全审查工具，利用 Claude 分析代码变更中的安全漏洞。该 Action 使用 Anthropic 的 Claude Code 工具进行深度语义安全分析，为 Pull Request (PR) 提供智能且具备上下文感知能力的安全评估。欲了解更多详情，请参阅我们的[博客文章](https://www.anthropic.com/news/automate-security-reviews-with-claude-code)。
