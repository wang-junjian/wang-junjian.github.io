...
### Python
* [Python3 文档](https://docs.python.org/zh-cn/3/)
...
## IoT
* [MicroPython 文档（英文）](https://docs.micropython.org/en/latest/index.html)
...
* [MicroPython 文档（中文）](http://docs.micropython.01studio.org/zh_CN/latest/index.html)
  ...
  - [ESP32 快速参考手册](http://docs.micropython.01studio.org/zh_CN/latest/esp32/quickref.html)
